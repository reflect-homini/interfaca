...
export function ProjectOnboarding({ onCreateProject }: ProjectOnboardingProps) {
  return (
    <div className="flex min-h-screen items-center justify-center auth-gradient-bg p-4">
      <div className="glass-panel p-12 text-center space-y-8 max-w-lg w-full slide-up">
        ...
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed max-w-sm mx-auto">
            Projects help you organize your reflections and insights.
            Create your first project to get started with AI-powered journaling.
          </p>
        </div>
